...
export default function CurriculumContentPage(){
 ...
 const preparation=<div className="mt-4 border-t border-border pt-4 space-y-4">
  ...
  <div className="flex flex-wrap gap-2"><Button variant="outline" onClick={()=>copy(MASTER_PROMPT,'Prompt Master copiado!')}>Copiar Prompt Master</Button><Button onClick={()=>data&&copy(exportLearningContext(data.cards,data.events,data.manualStage),'Conteúdo da etapa copiado!')}>Copiar conteúdo para IA</Button></div>
